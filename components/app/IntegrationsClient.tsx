  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="rounded-2xl border border-white/10 bg-zinc-900/50 overflow-hidden">
        ...
        >
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-xs text-zinc-500 mt-0.5">DMs automatisiert beantworten</div>
          </div>
          <span
          ...
          <ChevronDown
            className={`h-4 w-4 text-zinc-500 shrink-0 transition-transform duration-200 ${openCard === "instagram" ? "rotate-180" : ""}`}
          />
        </button>
          ...
          <div className="px-5 pb-5 border-t border-white/5">
            <div className="pt-4 space-y-4">
              ...
              {metaConnected && tokenExpiryInfo?.isExpired && (
                <div className="flex items-start gap-3 rounded-xl border border-rose-500/20 bg-rose-500/10 px-4 py-3 text-sm">
                  <AlertTriangle className="mt-0.5 h-4 w-4 text-rose-400" />
                  <div>
                    <div className="font-semibold text-rose-400">Token abgelaufen!</div>
                    <div className="text-rose-400/80">Bitte verbinde deinen Account erneut.</div>
                  </div>
                </div>
              )}
              {metaConnected && tokenExpiryInfo?.isExpiringSoon && !tokenExpiryInfo?.isExpired && (
                <div className="flex items-start gap-3 rounded-xl border border-amber-500/20 bg-amber-500/10 px-4 py-3 text-sm">
                  ...
                  <div>
                    ...
                    <div className="text-amber-400/80">Bitte verbinde deinen Account erneut.</div>
                  </div>
                </div>
              )}
              {error && (
              ...
              {!metaConnected && (
                <div className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-zinc-400">
                  ...
                  <ul className="mt-1.5 list-inside list-disc space-y-1 text-zinc-300">
                    <li>Instagram <span className="text-zinc-300">Business</span>- oder <span className="text-zinc-300">Creator</span>-Account</li>
      ...
      <div className="rounded-2xl border border-white/10 bg-zinc-900/50 overflow-hidden">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="font-semibold text-white text-sm">Google Kalender</div>
            <div className="text-xs text-zinc-500 mt-0.5">{labels.bookingPlural} automatisch eintragen</div>
          </div>
          <span
            className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-semibold shrink-0 ${
              googleConnected
          ...
          <ChevronDown
            className={`h-4 w-4 text-zinc-500 shrink-0 transition-transform duration-200 ${openCard === "google" ? "rotate-180" : ""}`}
          />
        </button>
          ...
          <div className="px-5 pb-5 border-t border-white/5">
            <div className="pt-4 space-y-4">
              {showGoogleSuccess && (
                <div className="flex items-center gap-2 rounded-xl border border-emerald-500/20 bg-emerald-500/10 px-4 py-3 text-sm text-emerald-400">
                  <CheckCircle className="h-4 w-4" />
                  {accountParam ? `Erfolgreich verbunden: ${accountParam}` : "Google Kalender wurde erfolgreich verbunden."}
                </div>
              )}
              ...
              <div className="flex flex-wrap gap-3">
                ...
                >
                  {googleConnecting ? "Verbinden..." : googleConnected ? "Erneut verbinden" : "Google Kalender verbinden"}
                </button>
                {googleConnected && (
                  <button
                    className="rounded-lg border border-rose-500/20 px-4 py-2.5 text-sm font-medium text-rose-400 transition-all hover:bg-rose-500/10"
              ...
              {googleConnected && !googleCalendarsLoading && googleCalendars.length > 0 && (
                <div className="rounded-xl border border-white/10 bg-white/5 px-4 py-4">
                  <div className="text-xs font-medium uppercase tracking-wider text-zinc-500">Kalenderauswahl</div>
                  <div className="mt-3 flex flex-col gap-3">
                    ...
                    <div className="text-xs text-zinc-400">Zeitzone: {googleCalendarTimeZone ?? "Unbekannt"}</div>
      ...
      <div className="rounded-2xl border border-white/10 bg-zinc-900/50 overflow-hidden">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="font-semibold text-white text-sm">Google Bewertungen</div>
            <div className="text-xs text-zinc-500 mt-0.5">Automatische Review-Anfragen</div>
          </div>
          <span
            className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-semibold shrink-0 ${
              reviewUrl
          ...
          <ChevronDown
            className={`h-4 w-4 text-zinc-500 shrink-0 transition-transform duration-200 ${openCard === "reviews" ? "rotate-180" : ""}`}
          />
        </button>
          ...
          <div className="px-5 pb-5 border-t border-white/5">
            <div className="pt-4 space-y-4">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-xs font-medium text-indigo-400 transition-colors hover:text-indigo-300"
              >
      ...
      <div className="rounded-2xl border border-white/10 bg-zinc-900/50 overflow-hidden">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="font-semibold text-white text-sm">WhatsApp Business</div>
            <div className="text-xs text-zinc-500 mt-0.5">In Kürze verfügbar</div>
          </div>
          <span className="rounded-full bg-indigo-500/10 px-2.5 py-1 text-xs font-semibold text-indigo-400 shrink-0">
            Bald verfügbar
          </span>
          <ChevronDown
            className={`h-4 w-4 text-zinc-500 shrink-0 transition-transform duration-200 ${openCard === "whatsapp" ? "rotate-180" : ""}`}
          />
        </button>
          ...
          <div className="px-5 pb-5 border-t border-white/5">
            <div className="pt-4 space-y-4">
              ...
              <button
                type="button"
                disabled
                className="cursor-not-allowed rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-medium text-zinc-500 opacity-70"
              >
      ...
      <div className="rounded-2xl border border-white/10 bg-zinc-900/50 overflow-hidden">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="font-semibold text-white text-sm">POS / Kassensystem</div>
            <div className="text-xs text-zinc-500 mt-0.5">Verfügbarkeiten synchronisieren</div>
          </div>
          <span className="rounded-full bg-zinc-500/10 px-2.5 py-1 text-xs font-semibold text-zinc-400 shrink-0">
            In Planung
          </span>
          <ChevronDown
            className={`h-4 w-4 text-zinc-500 shrink-0 transition-transform duration-200 ${openCard === "pos" ? "rotate-180" : ""}`}
          />
        </button>
        ...
        {openCard === "pos" && (
          <div className="px-5 pb-5 border-t border-white/5">
            <div className="pt-4 space-y-4">
              ...
              <button className="rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-medium text-zinc-400 transition-all hover:border-white/20 hover:text-white">
                Mehr erfahren
              </button>
            </div>
          </div>
