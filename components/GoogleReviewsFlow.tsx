        ...
        <div className={`relative overflow-hidden rounded-xl border bg-zinc-900/50 p-4 transition-all duration-500 sm:rounded-2xl sm:p-6 ${
          ...
          <div className="relative">
            ...
            <div className="mb-4 flex items-center gap-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500">
      ...
      <div className="mt-6 grid grid-cols-3 gap-2 sm:mt-8 sm:gap-4">
        {[
          ...
          <div key={item.label} className="rounded-lg border border-white/10 bg-zinc-900/50 p-2.5 text-center sm:rounded-xl sm:p-4">
            <div className={`text-sm font-semibold sm:text-base ${item.color}`}>{item.label}</div>
            <div className="mt-1 text-[10px] leading-relaxed text-zinc-500 sm:text-xs">{item.detail}</div>
          </div>
        ))}
      </div>
    </div>
